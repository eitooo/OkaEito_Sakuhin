...
//};
//
//struct e_data edata[AFlame];
//struct e_data la_data[LAFlame];
//struct e_data ma_data[MAFlame];
//struct e_data ha_data[HAFlame];
//
////Edit用
//void ImGui::ShowEditWindow()
//{ 
...
//    {
//        la_data[i].hurtbox1_x_pos = ld[2 + (5 * i)];
//        la_data[i].hurtbox1_y_pos = ld[3 + (5 * i)];
//        la_data[i].hurtbox1_height_s = ld[4 + (5 * i)];
//        la_data[i].hurtbox1_width_s = ld[5 + (5 * i)];
//    }
//
//    fclose(fp1);
//
...
//    {
//        ma_data[i].hurtbox1_x_pos = md[2 + (5 * i)];
//        ma_data[i].hurtbox1_y_pos = md[3 + (5 * i)];
//        ma_data[i].hurtbox1_height_s = md[4 + (5 * i)];
//        ma_data[i].hurtbox1_width_s = md[5 + (5 * i)];
//    }
//
//    //HeavyAttackデータ読み込み
...
//    {
//        ha_data[i].hurtbox1_x_pos = hd[2 + (5 * i)];
//        ha_data[i].hurtbox1_y_pos = hd[3 + (5 * i)];
//        ha_data[i].hurtbox1_height_s = hd[4 + (5 * i)];
//        ha_data[i].hurtbox1_width_s = hd[5 + (5 * i)];
//    }
//
//    fclose(fp1);
//
...
//        ImGui::Text("HP");
//        ImGui::SliderFloat("slider 1", &slider1, 0.0f, 1000.0f);
//        playerobj->SetNowHP(slider1);
//        ImGui::End();
//
//        ImGui::SetNextWindowSize(ImVec2(500, 500));
//        ImGui::Begin("Edit Window2");
//        ImGui::Text("STATUS");
//        ImGui::RadioButton("Idle", &mode, IDLE); ImGui::SameLine(); ImGui::RadioButton("Walk", &mode, WALK); ImGui::RadioButton("Jump", &mode, JUMP);
...
//        if (isEnable)
//        {
//            playerobj->Set_move(true);
//        }
//        else
//        {
//            playerobj->Set_move(false); //動きを停止 
//
//            //フレームをいじれるように
//            ImGui::Text("Flame");
//            ImGui::SliderInt("Flame", &flame1, 0, allflame);
//            playerobj->Set_m_Flame(flame1);
//        }
//
//        if (mode == IDLE)
//        {
//            playerobj->Set_status(PlayerBase::player_ste::Idle);
//
//            allflame = 0;
//        }
//        if (mode == WALK)
//        {
//            playerobj->Set_status(PlayerBase::player_ste::Walk);
//
//            allflame = 0;
//        }
//        if (mode == JUMP)
//        {
//            playerobj->Set_status(PlayerBase::player_ste::Jump);
//
//            allflame = 40;
//        }
//        if (mode == LIGHT_ATTACK)
//        {
//            playerobj->Set_status(PlayerBase::player_ste::Light_Attack);
//
//            allflame = 15;
//
...
//            {
//                ImGui::Text("Pos");
//                ImGui::SliderFloat("X_Pos", &la_data[flame1].hurtbox1_x_pos, -150.0f, 150.0f);
//                ImGui::SliderFloat("Y_Pos", &la_data[flame1].hurtbox1_y_pos, -150.0f, 150.0f);
//
//                ImGui::Text("height & width");
//                ImGui::SliderFloat("height", &la_data[flame1].hurtbox1_height_s, 0.0f, 500.0f);
//                ImGui::SliderFloat("width", &la_data[flame1].hurtbox1_width_s, 0.0f, 500.0f);
//
//                ImGui::TreePop();
//            }
//
...
//            {
//                ImGui::Text("Pos");
//                ImGui::SliderFloat("X_Pos", &la_data[flame1].hitbox1_x_pos, -300.0f, 300.0f);
//                ImGui::SliderFloat("Y_Pos", &la_data[flame1].hitbox1_y_pos, -150.0f, 150.0f);
//
//                ImGui::Text("height & width");
//                ImGui::SliderFloat("height", &la_data[flame1].hitbox1_height_s, 0.0f, 500.0f);
//                ImGui::SliderFloat("width", &la_data[flame1].hitbox1_width_s, 0.0f, 500.0f);
//
//                if (ImGui::Button("save"))
//                {
//                    /*fopen_s(&fp1, "data\\test.csv", "w");
//
//                    fprintf(fp1, "%d,%f,%f,%f,%f\n", flame1, la_data[flame1].hurtbox1_x_pos, la_data[flame1].hurtbox1_y_pos, edata[flame1].hurtbox1_height_s, edata[flame1].hurtbox1_height_s);
//                    fprintf(fp1, "%d,%f,%f,%f,%f\n", flame1, la_data[flame1].hitbox1_x_pos, la_data[flame1].hitbox1_y_pos, edata[flame1].hitbox1_height_s, edata[flame1].hitbox1_width_s);
//
//                    fclose(fp1);*/
//
//                }
...
//        {
//            playerobj->Set_status(PlayerBase::player_ste::Medium_Attack);
//
//            allflame = 25;
//
//            if (ImGui::TreeNode("Hurt Box 1"))
//            {
//                ImGui::Text("Pos");
//                ImGui::SliderFloat("X_Pos", &ma_data[flame1].hurtbox1_x_pos, -150.0f, 150.0f);
//                ImGui::SliderFloat("Y_Pos", &ma_data[flame1].hurtbox1_y_pos, -150.0f, 150.0f);
//
//                ImGui::Text("height & width");
//                ImGui::SliderFloat("height", &ma_data[flame1].hurtbox1_height_s, 0.0f, 500.0f);
//                ImGui::SliderFloat("width", &ma_data[flame1].hurtbox1_width_s, 0.0f, 500.0f);
//
//                ImGui::TreePop();
//            }
//
...
//            {
//                ImGui::Text("Pos");
//                ImGui::SliderFloat("X_Pos", &ma_data[flame1].hitbox1_x_pos, -300.0f, 300.0f);
//                ImGui::SliderFloat("Y_Pos", &ma_data[flame1].hitbox1_y_pos, -150.0f, 150.0f);
//
//                ImGui::Text("height & width");
//                ImGui::SliderFloat("height", &ma_data[flame1].hitbox1_height_s, 0.0f, 500.0f);
//                ImGui::SliderFloat("width", &ma_data[flame1].hitbox1_width_s, 0.0f, 500.0f);
//
//                if (ImGui::Button("save"))
//                {
//                    /*fopen_s(&fp1, "data\\test.csv", "w");
...
//        {
//            playerobj->Set_status(PlayerBase::player_ste::Heavy_Attack);
//
//            allflame = 35;
//
//            if (ImGui::TreeNode("Hurt Box 1"))
//            {
//                ImGui::Text("Pos");
//                ImGui::SliderFloat("X_Pos", &ha_data[flame1].hurtbox1_x_pos, -150.0f, 150.0f);
//                ImGui::SliderFloat("Y_Pos", &ha_data[flame1].hurtbox1_y_pos, -150.0f, 150.0f);
//
//                ImGui::Text("height & width");
//                ImGui::SliderFloat("height", &ha_data[flame1].hurtbox1_height_s, 0.0f, 500.0f);
//                ImGui::SliderFloat("width", &ha_data[flame1].hurtbox1_width_s, 0.0f, 500.0f);
//
//                ImGui::TreePop();
//            }
//
...
//            {
//                ImGui::Text("Pos");
//                ImGui::SliderFloat("X_Pos", &ha_data[flame1].hitbox1_x_pos, -300.0f, 300.0f);
//                ImGui::SliderFloat("Y_Pos", &ha_data[flame1].hitbox1_y_pos, -150.0f, 150.0f);
//
//                ImGui::Text("height & width");
//                ImGui::SliderFloat("height", &ha_data[flame1].hitbox1_height_s, 0.0f, 500.0f);
//                ImGui::SliderFloat("width", &ha_data[flame1].hitbox1_width_s, 0.0f, 500.0f);
//
//                if (ImGui::Button("save"))
//                {
//                    /*fopen_s(&fp1, "data\\test.csv", "w");
...
//
//        hurtobj->Set_xpos(edata[flame1].hurtbox1_x_pos);
//        hurtobj->Set_ypos(edata[flame1].hurtbox1_y_pos);
//
//        hurtobj->Set_eheight(abs(edata[flame1].hurtbox1_height_s));
//        hurtobj->Set_ewidth(abs(edata[flame1].hurtbox1_width_s));
//
//        edata[flame1].hitbox1_height_s = fabs(edata[flame1].hitbox1_height_s);
//        edata[flame1].hitbox1_width_s = fabs(edata[flame1].hitbox1_width_s);
//
//        hitobj->Set_xpos(edata[flame1].hitbox1_x_pos);
//        hitobj->Set_ypos(edata[flame1].hitbox1_y_pos);
//
//        hitobj->Set_eheight(abs(edata[flame1].hitbox1_height_s));
//        hitobj->Set_ewidth(abs(edata[flame1].hitbox1_width_s));
//
//        ImGui::End();
//
//    }

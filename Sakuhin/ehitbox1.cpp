...
void Ehitbox1::Update()
{
}

void Ehitbox1::Set_xpos(float xp)
{
	this->xpos = xp;
}

void Ehitbox1::Set_ypos(float yp)
{
	this->ypos = yp;
}

void Ehitbox1::Set_ewidth(float ew)
{
	this->ewidth = ew;
}

void Ehitbox1::Set_eheight(float eh)
{
	this->eheight = eh;
}
